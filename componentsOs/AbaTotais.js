...
export default function AbaTotais({
    ...
    const atualizarTotalOrdem = async () => {
      ...
      try {
        await apiPostComContexto(
          `ordemdeservico/ordens/${orde_nume}/atualizar_total/`,
          {
  ...
  const carregarTitulos = async () => {
    ...
    try {
      ...
      const response = await apiGetComContexto(
        `ordemdeservico/financeiro/consultar-titulos/${orde_nume}/`
      )
  ...
  const gerarTitulos = async () => {
    ...
    try {
      ...
      await apiPostComContexto(
        'ordemdeservico/financeiro/gerar-titulos/',
        payload
      )
  ...
  const removerTitulos = async () => {
    try {
      setLoading(true)
      await apiPostComContexto('ordemdeservico/financeiro/remover-titulos/', {
        orde_nume,
        empr: orde_empr,
        fili: orde_fili,
      })
  ...
  const salvarEdicaoTitulo = async () => {
    ...
    try {
      setLoading(true)
      await apiPostComContexto('ordemdeservico/financeiro/atualizar-titulo/', {
        orde_nume,
