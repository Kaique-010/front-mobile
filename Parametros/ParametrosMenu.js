    ...
    <View style={parametrosStyles.container}>
      ...
      >
        ...
        <View style={parametrosStyles.infoContainer}>
          <Text style={parametrosStyles.infoTitle}>Sobre o Sistema de Permissões</Text>
          <Text style={parametrosStyles.infoText}>
            O sistema de permissões permite controlar o acesso a módulos, telas e operações 
            específicas por empresa e filial. As configurações são aplicadas automaticamente 
            em todo o sistema.
          </Text>
          
          <View style={parametrosStyles.infoFeatures}>
            <Text style={parametrosStyles.infoFeatureTitle}>Funcionalidades:</Text>
            <Text style={parametrosStyles.infoFeature}>• Liberação/bloqueio de módulos</Text>
            <Text style={parametrosStyles.infoFeature}>• Controle granular de telas</Text>
            <Text style={parametrosStyles.infoFeature}>• Permissões por operação (CRUD)</Text>
            <Text style={parametrosStyles.infoFeature}>• Configurações de estoque</Text>
            <Text style={parametrosStyles.infoFeature}>• Configurações financeiras</Text>
            <Text style={parametrosStyles.infoFeature}>• Auditoria de alterações</Text>
          </View>
        </View>
      </ScrollView>
    </View>
