...
export default function ItensModalOs({
  ...
  useEffect(() => {
    if (itemEditando) {
      setForm({
        ...
        hectares: itemEditando.peca_hect?.toString() || '',
        desconto: itemEditando.peca_desc?.toString() || '',
        observacao: itemEditando.peca_obse || '',
  ...
  const adicionar = () => {
    ...
    const novoItem = {
      ...
      peca_unit: precoNum,
      peca_tota: total,
      peca_hect: hectaresNum,
      peca_desc: descontoNum,
      peca_obse: form.observacao,
