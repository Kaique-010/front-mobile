...
export default function DashRealizado() {
  ...
  // Função para obter cor baseada no percentual
  ...
  // Função para obter ícone baseado no percentual
  ...
  // Filtra contas conforme filtro
  const filtrarContas = (contas) => {
    // Primeiro filtra valores maiores que 0
  ...
  // Renderiza uma linha de conta (MELHORADA)
...
const styles = StyleSheet.create({
  ...
  mesButtonGrid: {
    width: '20%', // cabe 3 por linha (2 linhas de 6 meses)
    paddingVertical: 4,
    borderRadius: 6,
