...
import { fetchClienteImagensDurante } from '../../services/clienteService'
...
const AbaFotosDurante = ({ ordemId }) => {
  ...
  const carregarImagens = async () => {
    try {
      setLoading(true)
      const data = await fetchClienteImagensDurante(ordemId)
      setImagens(data)
    } catch (error) {
      console.error('Erro ao carregar imagens durante:', error)
    } finally {
      setLoading(false)
    }
  }
...
export default AbaFotosDurante
