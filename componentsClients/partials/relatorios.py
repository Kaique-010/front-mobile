...
class OrdemServicoViewSet(BaseClienteViewSet):
    ...
    def listar_imagens_antes(self, request, *args, **kwargs):
        try:
            ...
            imagensAntes = Ordemservicoimgantes.objects.using(request.banco).filter(iman_orde=orde_nume)
    ...
    def listar_imagens_depois(self, request, *args, **kwargs):
        try:
            ...
            imagensDepois = Ordemservicoimgdepois.objects.using(request.banco).filter(imde_orde=orde_nume)
            context = self.get_serializer_context()
    ...
    def listar_imagens_durante(self, request, *args, **kwargs):
        try:
            ...
            imagensDurante = Ordemservicoimgdurante.objects.using(request.banco).filter(imdu_orde=orde_nume)
            context = self.get_serializer_context()
